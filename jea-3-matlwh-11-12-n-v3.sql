...
/* Change log
v.1: Inital version. Select only A-assortment plus B/C for PacsOn Väst. Since Väst has one EWM location it can be loaded in conjunction with MARC & MARD. Refer:
...
*/
/* Remove v.3.
  (ars.ForetagKod = 9100 AND ars.LagStalle IN ('5000') )  -- Väst: Falköping. Add v.1.
