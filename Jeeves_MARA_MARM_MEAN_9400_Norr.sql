...
v.5w: Column MARA_MSTDE with date.
     !!! Fork from jea-2-mara-makt-mean-11-12-v5w.sql to jea-4-mara-makt-mean-21-v5w.sql for articles with extra4 = 21 !!!
...
cte_artnr_west AS (  -- Add v.4w.
  ...
  WHERE
    ...
    AND ar_2000.extra4 IN (21)  -- Change v.5w.
...
WHERE
  ar.foretagkod = 2000  -- Mall
--  AND ar.artnr IN (SELECT artnr FROM cte_artnr)  -- AR.extra4 subquery. Remove v.4w.
  AND ar.artnr IN (SELECT artnr FROM cte_artnr_west)  -- AR.extra4 subquery. Add v.4w.
ORDER BY 2;
