...
/* Change log
v.1: Initial version. Select only A-assortment plus B/C for PacsOn Norr. Refer:
...
*/
    AND (ar_2000.q_saps4_sortiment IN ('A', 'B')  -- A/B-sortiment: alla artiklar. Change v.2.
         OR (ar_2000.q_saps4_sortiment IN ('C') AND ar_9400.artnr IS NOT NULL))  -- C-sortiment: endast artiklar som finns i Norr 9400. Change v.2.
),
...
--  AND ar_op.ForetagKod IN (9400)  -- Norr. Add v.1. Remove v.3.
